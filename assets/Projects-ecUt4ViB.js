...
`,m=({children:e,onClick:r})=>t.jsx(S,{onClick:r,children:e});m.propTypes={children:o.node.isRequired,onClick:o.func};const u=({children:e,onClick:r})=>t.jsx(q,{onClick:r,children:e});u.propTypes={children:o.node.isRequired,onClick:o.func};const E=()=>{const{t:e}=p(),r=l.useRef(null),a=l.useRef(null),c=i=>{var d;(d=i.current)==null||d.scrollIntoView({behavior:"smooth"})};return t.jsxs(x,{children:[t.jsxs(k,{children:[t.jsx(m,{onClick:()=>c(r),children:e("buttons.team")}),t.jsx(u,{onClick:()=>c(a),children:e("buttons.personal")})]}),t.jsxs("section",{ref:r,id:"team",children:[t.jsx("h2",{children:e("projects.teamTitle")}),P.map(i=>t.jsx(n,{project:i},i.id))]}),t.jsxs("section",{ref:a,id:"personal",children:[t.jsx("h2",{children:e("projects.personalTitle")}),T.map(i=>t.jsx(n,{project:i},i.id))]})]})};export{E as default};
